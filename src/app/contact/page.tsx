      ...
      <Section className="pt-28 pb-24">
        <div className="text-center mb-10">
          ...
          <p className="text-lg md:text-xl text-gray-800 pt-serif-regular max-w-2xl mx-auto">
            Whether you're a parent with feedback, a potential partner, or just
            curious about what we're building, reach out. We read every message
            and do our best to reply within a few days.
          </p>
        </div>
