      ...
      >
        <div className="relative z-10 px-4 max-w-6xl mx-auto w-full">
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-base md:text-lg text-darkblue leading-relaxed pt-serif-regular">
              I started it because, at a certain point, family travel started to
              feel almost impossible.
            </p>

            <p className="text-base md:text-lg text-darkblue leading-relaxed pt-serif-regular">
              After our third son, the thought of planning a trip felt
              overwhelming. Not just the big pieces - flights or accommodations
              - but all the in-between details that parents quietly carry: what
              to pack, how to get around with kids, what daily life would
              actually look like once we arrived. The information was out there,
              but it was scattered, impersonal, and often didn&apos;t apply to
              families like ours.
            </p>
            ...
            <p className="text-base md:text-lg text-darkblue leading-relaxed pt-serif-regular">
              Two years earlier, I was on a plane with our three-month-old son.
              I was figuring things out as I went - all trial, almost all errors
              and countless kind strangers helping me along the way. At some
              point during the flight, another mom traveling alone with her baby
              needed help. Without thinking twice, I stepped in. Not because I
              had special expertise, but because I was living it too. We
              understood each other instantly.
            </p>
            ...
            <p className="text-base md:text-lg text-darkblue leading-relaxed pt-serif-regular">
              ...
              need each other. We need the kind of insight that only comes from
              lived experience, shared honestly, without judgment. Parents
              helping parents travel better together.
            </p>
            ...
            <p className="text-base md:text-lg text-darkblue leading-relaxed pt-serif-regular">
              ...
              details matter and trust matters. Where one-size-fits-all advice
            ...
            <p className="text-base md:text-lg text-darkblue leading-relaxed pt-serif-regular">
              Not as a platform driven by influence or volume, but as a trusted
              place for experience to be shared, organized, and respected. A
              place where families - and eventually all kinds of travelers - can
            ...
            <p className="text-base md:text-lg text-darkblue leading-relaxed pt-serif-regular">
              ...
              as I do, that travel can be easier when we learn from one another.
            </p>
