                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <ul className="text-gray-700 text-sm leading-relaxed space-y-1 ml-4">
                        ...
                        <li>• Pay creators fairly</li>
                        <li>• Improve with AI moderation & suggestions</li>
                        <li>
            ...
            <section id="full-privacy-policy" className="mb-12">
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Travel guides, posts, messages, reviews, and other
                      material you upload.
                    </p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      (e.g., Stripe, PayPal). We do not store full payment card
                      details.
                    </p>
                  </div>
                  <div>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc list-inside text-gray-700 leading-relaxed space-y-2 ml-4">
                  ...
                  <li>Enable payments and creator payouts.</li>
                  <li>
              ...
              <section className="mb-8">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Content you post (e.g., guides, reviews) is visible to
                      other users.
                    </p>
                  </div>
                </div>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  by individuals 18 or older. Children may access the Platform
                  only under the supervision of a parent or guardian. We do not
                  knowingly collect personal data directly from children under
                  13.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  your data. However, no online service can be completely
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  <a
                    href="mailto:privacy@wewandr.com"
                    className="text-orange-600 hover:text-orange-700 font-semibold"
                  >
                    privacy@wewandr.com
                  </a>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  We may update this Privacy Policy as WeWandr grows. Updates
